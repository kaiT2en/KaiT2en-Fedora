...
before contacting the T2, writes a fixed `bridgeos.jsonl.partial`, and
...
If direct discovery fails, it falls back to a dynamic-port scan because we
don't know yet if `59602` is universal.
